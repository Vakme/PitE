...
#cooperates with TrIntegrator module. Solves an integral, shows result and compares it to scipy.integral.trapz
	def SolveIntegrator(self):
		...
		integ = TrIntegrator()
		print ("The result is %2.4f") %integ.SolveIntegrator(self.obj)
		print ("Do you want to compare it with scipy?")
		if self.CheckIfSo() == True:
			print ("Comparing with scipy.integral method...")
			print ("The result is %2.4f") %integ.SolveTrapz(self.obj)
		self.EndApp()
